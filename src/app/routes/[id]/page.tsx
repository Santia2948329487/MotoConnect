    ...
    <div className="min-h-screen bg-neutral-950 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Link href="/routes">
            <button className="p-2 bg-neutral-800 hover:bg-red-600 text-white rounded-lg transition">
...
const StatItem = ({
  ...
  return (
    <div className="flex justify-between items-center py-3 border-b border-neutral-800 last:border-b-0">
      ...
      <span
        className={`font-bold text-sm px-2 py-1 rounded border ${valueClassName}`}
      >
        {value}
      </span>
    </div>
